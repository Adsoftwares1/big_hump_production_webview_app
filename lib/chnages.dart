class Changes {
  // main website url
  static String mainUrl = 'https://bighumpproductions.com/';
  ...
  static String startPointUrl = 'https://bighumpproductions';
  ...
  static String AppTitle = 'Big Hump Productions';
  ...
  //2-  flutter pub global run rename --bundleId com.nightcoders.webviewprotemplate
  //3-  flutter pub global run rename --appname "Naija Chef Hub"

  // image_path: "assets/images/icon.png"
  // flutter pub run flutter_launcher_icons

  // # background_image: "assets/images/backgroundsplash.png"
  // color: "#ffffff"
